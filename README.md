...
`main` at `v0.12.0`, pushed to [DamoDCoder/signal-garden](https://github.com/DamoDCoder/signal-garden). Everything passes under `task check`.
...
Metrics, worker-count/batch-size, the load generator, and failure injection are done — see above. Left: OpenTelemetry traces and client sliders for the daemon-side controls. It is also where two deferrals finally get numbers instead of guesses:
