...
Metrics, worker-count/batch-size, the load generator, failure injection, and traces are done — see above. Left: client sliders for the daemon-side controls and the compact in-app performance view, both client-repo. It is also where two deferrals finally get numbers instead of guesses:
