...
What exists today: `test`, `test-race`, `check`, `run`, `live`, `serve`, `demo`, `build`, `build:docker`, `docker:build`, `docker:run`, `docker:images`, `fmt`, `vet`, `proto`, `tools`, and `clean`.
